...
<head>
    ...
    <style type="text/css" media="screen">@import "{$URL}spacebattles/css/cdn/darkorbit.css";</style>

    <meta http-equiv="Content-Language" content="{implode($server->tags, " , ")}">
    <meta name="language" content="{implode($server->tags, " , ")}">
    <meta http-equiv="content-type" content="text/html; charset=utf-8"/>

    <script src="{$URL}spacebattles/js/function.js" type="text/javascript"></script>
    <script type="text/javascript" src="{$URL}spacebattles/js/jQuery/jquery-1.4.4.min.js"></script>
    <script type="text/javascript" src="{$URL}spacebattles/js/jQuery/jquery.flashembed.js"></script>
    <script type="text/javascript">jQuery.noConflict();</script>
    <script type="text/javascript" src="{$URL}spacebattles/resources/js/tools.js"></script>
    <script type="text/javascript" src="{$URL}spacebattles/resources/js/tools/text.js"></script>
    ...
    <script type="text/javascript" src="{$URL}spacebattles/resources/js/tools/popup.js"></script>
    <script type="text/javascript" src="{$URL}spacebattles/resources/js/tools/errorHandler.js"></script>
    <script type="text/javascript" src="{$URL}spacebattles/resources/js/library.js"></script>
    <script src="{$URL}spacebattles/resources/js/internalMapRevolution.js" type="text/javascript"></script>
    <script type="text/javascript">
