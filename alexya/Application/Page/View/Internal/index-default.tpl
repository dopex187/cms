...
<head>
    ...
    <script type='text/javascript' src='{$theme->url()}js/plugins/jquery/jquery-migrate.min.js'></script>
    <script type='text/javascript' src='{$theme->url()}js/plugins/jquery/globalize.js'></script>
    <script type='text/javascript' src='{$theme->url()}js/plugins/bootstrap/bootstrap.min.js'></script>

    <script type='text/javascript' src='{$theme->url()}js/plugins/mcustomscrollbar/jquery.mCustomScrollbar.min.js'></script>
    <script type='text/javascript' src='{$theme->url()}js/plugins/uniform/jquery.uniform.min.js'></script>

    <script type='text/javascript' src='{$theme->url()}js/plugins/sparkline/jquery.sparkline.min.js'></script>
    <script type='text/javascript' src='{$theme->url()}js/plugins/flot/jquery.flot.js'></script>
    <script type='text/javascript' src='{$theme->url()}js/plugins/flot/jquery.flot.resize.js'></script>

    <script type='text/javascript' src='{$theme->url()}js/plugins.js'></script>
    <script type='text/javascript' src='{$theme->url()}js/actions.js'></script>
...
<body class="bg-img-num1">
            ...
            <ul class="page-navigation">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="{$URL}Internal/Shop/Ammunition">{t("Ammunition")}</a></li>
                        <li><a href="{$URL}Internal/Shop/PET">{t("PET")}</a></li>
                        <li><a href="{$URL}Internal/Shop/Extras">{t("Extras")}</a></li>
                        <li><a href="{$URL}Internal/Shop/Designs">{t("Designs")}</a></li>
                    </ul>
                </li>
                <li>
    ...
    var NewsController = {
        ...
        /**
         * Initializes scroller and sets onclick events
         */
        init: function()
        {
            this.initScroller();

            jQuery("#news-slider").find("> li").click(function() {
